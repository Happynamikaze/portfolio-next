...
import warLogo from '../../../public/images/logo_white.svg';
                        ...
                        <div className={styles['item-left']}>
                            <Link href='/'>
                                <div className={styles['logo']}>
                                    <Image src={warLogo} alt="logo" height={30} width={30} />
                                    <span className={`logo-text mb-0 ${prompt.className}`}><span className='primary-color'>War</span>Clouser</span>
                                </div>
                            </Link>
                        </div>
