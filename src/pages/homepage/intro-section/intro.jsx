...
export default function Intro() {
    ...
    useEffect(() => {
        document.querySelectorAll('.age').forEach((e)=>{
            e.innerText = calculateAge('2002-08-24');
        })
    })
                ...
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        ...
                        <motion.div initial={ani.init} whileInView={ani.inView} transition={{duration:.5, delay:.6}} className="button-group">
                            <Link href="mailto:sarabjeetcing@gmail.com" className={`theme_button ${styles['intro-button']}`}>:hireMe() <FaUserTie /></Link>
                            <Link href='/docs/sarabjeet_cv.pdf' className={`theme_button ${styles['intro-button']}`}>:resume() <FaFileArrowDown /></Link>
                        </motion.div>
                    </div>
                    <div className="col-lg-6">
